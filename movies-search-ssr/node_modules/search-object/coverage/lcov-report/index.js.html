...
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">function handleNestedArray(arr) {
...
function searchObject(obj, value) {
	<span class="missing-if-branch" title="if path not taken" >I</span>if (obj === undefined || value === undefined) {
...
&nbsp;
	<span class="missing-if-branch" title="if path not taken" >I</span>if (obj.constructor !== Object) {
<span class="cstat-no" title="statement not covered" >		throw new Error("First argument must be of type Object");</span>
	}
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Fri Feb 15 2019 06:15:55 GMT+0000 (GMT)
</div>
</div>
